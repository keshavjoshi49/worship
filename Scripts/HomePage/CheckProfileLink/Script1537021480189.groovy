/*
 * This test cases validates the Profile page.
 */
...
//Check the presence of Profile Page.
WebUI.click(findTestObject('Page_CCCH Worship - Home/div_Profiles'), FailureHandling.STOP_ON_FAILURE)
String title= WebUI.getWindowTitle()
WebUI.verifyMatch(title, 'CCCH Worship - Profiles', true, FailureHandling.STOP_ON_FAILURE)
