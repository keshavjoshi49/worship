/*
 * This test cases validates the Video blog Page
 */
...
//Check the presence of Video blog Page.
WebUI.click(findTestObject('Page_CCCH Worship - Home/div_Vblog'), FailureHandling.STOP_ON_FAILURE)
String title= WebUI.getWindowTitle()
WebUI.verifyMatch(title, 'CCCH Worship - Video Blog Archive', true, FailureHandling.STOP_ON_FAILURE)
WebUI.verifyTextPresent('Add New Video', true, FailureHandling.STOP_ON_FAILURE)
